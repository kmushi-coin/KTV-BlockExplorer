...
// KTVRPC is an interface to JSON-RPC bitcoind service.
type KTVRPC struct {
    *btc.BitcoinRPC
    BitcoinGetChainInfo func() (*bchain.ChainInfo, error)
}

// NewKTVRPC returns new KTVRPC instance.
func NewKTVRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
...
// Initialize initializes KTVRPC instance.
func (b *KTVRPC) Initialize() error {
    ...
    b.Parser = NewKTVParser(params, b.ChainConfig)
...
func (z *KTVRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
    var err error
    if hash == "" && height > 0 {
...
func (b *KTVRPC) GetNextSuperBlock(nHeight int) int {
...
// KTV adds Money Supply to btc implementation
func (b *KTVRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (b *KTVRPC) Findzcserial(serialHex string) (string, error) {
